               ...
               <Col sm={6}>
                   ...
                   <Form.Group controlId="StoreID">
                            <Form.Control type="text" name="StoreID" required 
                             placeholder="StoreID" disabled defaultValue={this.props.storeid}></Form.Control>
                       </Form.Group>

                       <Form.Group controlId="Name">
                            <Form.Control type="text" name="Name" required 
                            placeholder="Name" defaultValue={this.props.stname}></Form.Control>
                       </Form.Group>

                       <Form.Group controlId="Address">
                           <Form.Control type="text" name="Address" required
                           placeholder="Address" defaultValue={this.props.staddress}></Form.Control>
                       </Form.Group>
